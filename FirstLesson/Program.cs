Console.WriteLine("Adınızı giriniz: "); //The user was asked to enter his/her name
string userName = Console.ReadLine();

Console.WriteLine("Soyadınızı giriniz"); //The user was asked to enter his/her username
